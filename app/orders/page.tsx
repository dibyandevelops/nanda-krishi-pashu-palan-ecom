...
export default function OrdersPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f8ead2] text-[#3c2c1e] flex flex-col">
      ...
      <footer className="mt-auto border-t border-[#d8bc98] bg-[#f7ead1] px-4 py-6 text-sm text-[#5c4024] sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href={whatsappUrl} target="_blank" rel="noreferrer" className="rounded-lg bg-[#25d366] px-3 py-2 font-semibold text-white">
              WhatsApp Us
            </a>
            <p>
              Need a similar application?{" "}
              <a href="https://dibyan.com.np" target="_blank" rel="noreferrer" className="font-semibold text-[#3f7c2d] underline">
                dibyan.com.np
              </a>
            </p>
          </div>
